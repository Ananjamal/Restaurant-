<div>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3 input-container">
            ...
            <input type="text" wire:model="title" class="form-control text-dark">
            @error('title')
        ...
        <div class="form-group">
            <label for="exampleFormControlInput1" class="text-dark"> Picture</label>
        ...
        <div>
            ...
            @elseif($gallery->image)
                ...
                <img src="{{ Storage::url($gallery->image) }}" height="100" width="100" alt="Category Image">
            @endif
        </div>
        ...
        <div class="modal-footer">
            ...
            <button type="button" wire:click="UpdateGallery" class="btn btn-primary">Save </button>
        </div>
