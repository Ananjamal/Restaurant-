...
class Menus extends Component
{
    ...
    public function mount()
    {
        ...
        // Optionally, load items for the first category on mount
        if ($this->categories->isNotEmpty()) {
            $this->getID($this->categories->first()->id);
        }
    }

    public function getID($id)
    {
        $this->items = Menu::where('category_id', $id)->get();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.website.menus.menus');
    }
}
